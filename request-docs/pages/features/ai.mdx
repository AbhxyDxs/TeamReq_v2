...
TeamReq also uses AI to verify the requirements written by students. When creating a new requirement, students will be provided with the
...
- Visit [Playground](/other-features/playground) to see other AI integration in TeamReq.
